...
{
    if(face_number == 0)
        this->inner_product_JxW(input_vect, weight_vect, output_vect, basis_surf[0], basis_vol, basis_vol, adding, factor);
    if(face_number == 1)
        this->inner_product_JxW(input_vect, weight_vect, output_vect, basis_surf[1], basis_vol, basis_vol, adding, factor);
    if(face_number == 2)
        this->inner_product_JxW(input_vect, weight_vect, output_vect, basis_vol, basis_surf[0], basis_vol, adding, factor);
    if(face_number == 3)
        this->inner_product_JxW(input_vect, weight_vect, output_vect, basis_vol, basis_surf[1], basis_vol, adding, factor);
    if(face_number == 4)
        this->inner_product_JxW(input_vect, weight_vect, output_vect, basis_vol, basis_vol, basis_surf[0], adding, factor);
    if(face_number == 5)
        this->inner_product_JxW(input_vect, weight_vect, output_vect, basis_vol, basis_vol, basis_surf[1], adding, factor);
}
