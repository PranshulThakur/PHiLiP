...
template <int dim, int nspecies, int nstate, typename real, typename MeshType>
void DGBaseState<dim,nspecies,nstate,real,MeshType>::set_unsteady_model_time_step(
...
template <int dim, int nspecies, int nstate, typename real, typename MeshType>
void DGBaseState<dim,nspecies,nstate,real,MeshType>::set_store_vol_flux_nodes()
{
...
template <int dim, int nspecies, int nstate, typename real, typename MeshType>
void DGBaseState<dim,nspecies,nstate,real,MeshType>::set_store_surf_flux_nodes()
{
